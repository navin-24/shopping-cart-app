...
<section class="dvProductDetail">
    <div class="container d-none d-lg-block">
        <div class="row">
            ...
            <div class="col-sm-12 detailbreadcrumb" style="padding:0;">
                    <?= generateBreadcrumbProductDetail($product_detail['product_name']); ?>                
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="description row">
                    <div class="dvDetailPageSlider col-lg-6">
                    <div class="owl-carousel">
                        <?php 
                        /*foreach (json_decode($product_detail['desktop_image_url'],1) as $image) { ?>
                            <div class="itemdiv">
                                <img src="<?= PRODUCT_BASE_PATH . $category_name . '/d/' . $image; ?>" alt="">
                            </div>
                        <?php } */?>
                        <?php 
                        if(isJson($product_detail['desktop_image_url'])){
                            foreach (json_decode($product_detail['desktop_image_url'],1) as $image) { ?>
                            <div class="itemdiv">
                                <img src="<?= PRODUCT_BASE_PATH . $category_name . '/d/' . $image; ?>" alt="">
                            </div>
                        <?php }    
                            ...
                            <div class="itemdiv">
                                <img src="<?= PRODUCT_BASE_PATH . $category_name . '/d/' . $product_detail['desktop_image_url']; ?>" alt="">
                            </div>
                        <?php } ?>
                        
                    </div>
                    </div>
                    <div class="col-lg-6 padd d-flex justify-content-center align-items-center justify-content-lg-start" style="padding:0 15px;">
                        <div>
                        <div class="row about">
                            <div class="col-md-12">
                                <div>
...
<script>
    $(document).ready(function(){
        $('.dvDetailPageSlider .owl-carousel').owlCarousel({
            loop:true,
            dots: true,
            margin:0,
