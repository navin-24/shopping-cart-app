                    ...
                    <?php } else { ?>
                        ...
                        <?php if ($category == 'subscriptions') { ?>
                            <div style="height:65px;">
                                ...
                                $bottle4week = preg_replace('/[^0-9]/', '', end($arr));
                                ...
                                if ($product_row['sku'] == '1130161') {
                                    echo '<p class="off">Get 20% off</p>';
                                }
                            } else {
                                ?>
                                <div>
                        ...
                        <div>
                            ...
                            if (isset($product_row['option_txt']) && $product_row['option_txt'] != '') {
                                ...
                                <div class="select3Options d-flex flex-sm-wrap justify-content-center">
                                    ...
                                    foreach ($option_txt_arr as $key => $row) {
                                        ...
                                        ?>
                                        <div class="opt">
                                            <input type="radio" id="control_<?= $value; ?>" name="<?= $product_id; ?>" value="<?= $row['option_type_id']; ?>" <?= $radioChecked; ?> option_name = '<?= $row['option_name'] ?>' >
                            ...
                            if ($product_row['is_in_stock']) {
                                $cityIdStr = $productCityArr[$product_id];
                                if ($cityIdStr !== NULL) {
                                    
                                    $cityIdArr = explode(',', $cityIdStr);
