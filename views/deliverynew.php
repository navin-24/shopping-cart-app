...
<div class="dvLS dvBulkOrderForm" id='deliveryBoyFormInfo'>
    <div class="container">
        <div class="row">
            <div class="dvLogin deliveryBoy col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                <div class="col-sm-12">
                    ...
                    <div class="deliveryboymobile col-sm-12 text-center">
                        <label class="bold">Your Mobile Number</label>
                        <input type="text" class="form-control mobile" name="db_mobileNumber" id="db_mobileNumber" autocomplete="off" maxlength="10" onkeypress="return isNumberKey(this, event);" placeholder="Enter your Mobile Number">
                    </div>
                    <div class="otp col-sm-12">
                        <input id="otp" type="text" class="form-control" placeholder="Enter OTP" maxlength="6" value="" autocomplete="off" maxlength="6" onkeypress="return isNumberKey(this, event);" style='display:none;'>
                    </div>
                </div>
                <div class="otp col-sm-12">
...
<div class="dvLS dvBulkOrderForm" id='customerInfoForm' style="display: none;">
    <div class="container">
        <div class="row">
            ...
            <div class="dvLogin customerForm col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                <div class="submit col-sm-12 d-flex justify-content-between align-items-center">
                    <p class="text-left">Welcome <?= $deliveryboy_name; ?>,</p>
                    <div class="text-right">
                        <button class="btn btnSecondary" id="logout">LOGOUT</button>    
                    </div>
                </div>
                <div class="customermobile col-sm-12">
                    <label class="bold">Customer Mobile Number</label>
                    <input type="text" class="form-control mobile" name="cust_mobileNumber" id="cust_mobileNumber" autocomplete="off" maxlength="10" onkeypress="return isNumberKey(this, event);" placeholder="Enter Customer mobile Number">
                </div>
                <div class="col-sm-12">
...
<div class="dvModal">
    <div id="customerNotified" class="modal" style="display:none;">
        <div class="modal-content modal-center text-center">
            <div class="container">
                <div class="row">
                    <div class="dvLogin col-12">
                        <div class="row">
...
var db_mobile = "<?php echo $db_mobileNumber; ?>"
if(db_mobile!=''){
    $("#customerInfoForm").show();
    $("#delivery_boy_mobile").val(db_mobile);
...
$("#logout").on('click',function(){
    window.location.replace("<?php echo base_url('DeliveryNew/logout'); ?>");
});
...
$("#cust_continue").on('click', function () {
    ...
    if(!delivery_boy_mobile){
        window.location.replace("<?php echo base_url('DeliveryNew'); ?>");
        ...
        setTimeout(function(){
            ...
            var url = 'DeliveryNew/deliveryDetails';
...
var close = $("#customerNotified .close")[0];
close.onclick = function () {
    $("#customerNotified").hide();
    location.reload();
}
...
$(document).click(function() { 
    if($('#customerNotified').is(':visible')) {
        $("#customerNotified").hide();
        location.reload();
    }
});
